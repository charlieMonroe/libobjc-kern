...
public:
  ...
  enum Kind {
    ...
    /// 'kernel-runtime' is the Objective-C runtime for FreeBSD kernel
    KernelObjC
  };
...
public:
  ...
  bool hasSubscripting() const {
    ...
    case GNUstep: return true;
    case ObjFW: return true;
    case KernelObjC: return false; // No library supports it at this moment
    }
    llvm_unreachable("bad kind");
  }
